...
export const GTFO_PING = '/api/ping';
export const GTFO_MAP_ANCHOR = 'west-lobby';
export const GTFO_ID = 'office-insights-cxm';

export const PRODUCTION_HOST_AVAILABILITY = 'http://ec2-50-16-10-211.compute-1.amazonaws.com';
export const PRODUCTION_HOST_PORT = '8080';
